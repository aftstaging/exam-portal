      ...
      <main className="container exam-container py-7">
        ...
        {isIntro && (
          <Card className="exam-card mx-auto max-w-5xl">
            <CardContent className="p-9">
              ...
              {sectionScenario && <div className="mt-5 rounded-xl border border-[#00e5ff]/30 bg-[#18093c] p-5"><div className="text-xs font-bold uppercase tracking-[.16em] text-[#00e5ff]">Scenario</div><StructuredText className="mt-2 text-sm leading-6 text-[#c4b5fd]" text={sectionScenario} /></div>}
        ...
        {isQuestion && (
          <Card className="exam-card mx-auto max-w-5xl question-workspace-card"><CardContent className="p-7 md:p-9">
            ...
            {sectionScenario && sectionQuestion && <div className="mt-4 rounded-xl border border-[#00e5ff]/30 bg-[#18093c] p-5"><div className="text-xs font-bold uppercase tracking-[.16em] text-[#00e5ff]">Scenario</div><StructuredText className="mt-2 text-sm leading-6 text-[#c4b5fd]" text={sectionScenario} /></div>}
